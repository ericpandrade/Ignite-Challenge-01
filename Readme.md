...
Challenge 1 Ignite. Challenge consists in do a To-do-list, with functionalities: Create, delete and check the task. This challenge has the intent to practice the abilities of states, and functions on REACT!
</span>
